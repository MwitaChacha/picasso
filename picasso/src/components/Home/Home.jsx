  ...
  if (!loading) {
    return (
      <div className="text-center items-center">
        ...
        <p className="mt-10 text-xs font-bold text-slate-600 animate-pulse">welcome to my gallery</p>
      </div>
    );
  } else {
    return (
      <div>
        <div className="lg:hidden">
          <p className="text-right p-5 font-bold text-slate-600">welcome</p>
          <div className="">
            {photos.map((item) => {
              return (
                <>
                  <motion.img
                    ...
                    onHoverStart={(e) => {}}
                    onHoverEnd={(e) => {}}
                    className="small-img mt-20 shadow-xl mx-auto"
                    key={item.id}
                    src={item.image}
                    alt=""
                  />
